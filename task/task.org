...
**** ResLife
***** 2.5 hours non-billable.  Corrected a series of bugs reported by Mary.
*** 05
**** WEEKEND
*** 06 
**** WEEKEND
...
**** HCGS
***** 5 hours billable.  Restared work on project.  Begin by making changes based on feedback from HCGS.
*** 08
**** HCGS
***** 4 hours billable.  Restared work on project.  Begin by making changes based on feedback from HCGS.
**** NHIHPP
...
*** 10
**** HCGS
***** 4 hours billable.  Finished changes based on feedback from HCGS.
*** 11
**** OCM
...
***** 1.5 hours billable.  Started working on items from my meeting with Rob.
*** 12
**** WEEKEND
*** 13
**** WEEKEND
...
**** HCGS 
***** 3 hour billable.  Continued work on issues from Meeting.  I hope to have an update ready for Thursday.
**** Housing
...
**** RCC
***** 1.5 hour non-billable.  Moved fudd up to Annette Schloss's office.  Moved hard-drives to Machine Room.  Spoke to Jenniffer about swaping phone wall-jacks.
**** HCGS
...
**** OCM
***** 3 hours non-billable.  Meeting with OCM to discuss outstanding bugs, remaining work for HDWTs and summery work.
*** 19
**** WEEKEND
*** 20
**** WEEKEND
