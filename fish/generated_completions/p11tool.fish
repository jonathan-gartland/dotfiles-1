...
complete -c p11tool -l export-chain --description 'Export the certificate specified by the URL and… [See Man Page]'
...
complete -c p11tool -l generate-random --description 'Generate random data.'
...
complete -c p11tool -l outder -l no-outder --description 'Use DER format for output certificates, private… [See Man Page]'
complete -c p11tool -l outraw --description 'This is an alias for the --outder option.'
