...
complete -c gnutls-cli -l noticket --description 'Don\'t allow session tickets. sp.'
complete -c gnutls-cli -l srtp-profiles --description 'Offer SRTP profiles. sp.'
complete -c gnutls-cli -l alpn --description 'Application layer protocol.'
...
complete -c gnutls-cli -l inline-commands --description 'Inline commands of the form ^<cmd>^.'
complete -c gnutls-cli -l inline-commands-prefix --description 'Change the default (^) used as a delimiter for inline commands.'
