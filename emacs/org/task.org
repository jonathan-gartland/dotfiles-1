...
*** 08
**** Obliterase
***** 3 hours billable.  Meet with Tucker to discuss updates to system wipe cert.  Completed updates and sent update to Tucker.
*** 09
**** NHIHPP
***** 2 hours billable.  Created wrapper around shred command line tool.  Sent update to aew.
***** 2 hour non-billable.  Tested/researched various system monitor reporting tools (cacti).
*** 10
**** ResLife
...
**** SpiceCore
***** 2 hour non-billable.  Helped Joe update the DNS record for spicecore.org.  Populated spicecore database with data from waisdivide db.  Updated all perl modules and shtml files  to use SPICECORE packages.
**** NHIHPP
***** 2 hour non-billable.  Tested/researched various system monitor reporting tools (ganglia).
...
**** NHIHPP
***** 2 hour non-billable.  Tested/researched various system monitor reporting tools (nagios).
...
**** HCGS
***** 2 hour non-billable.  Moved HCGS to git.  Created accounts for Rob, Kelly and Krystalynne.  Fixed issue with ForgotPassword module.
