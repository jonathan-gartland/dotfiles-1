...
CPPPATH_NODE = '/home/skk/dot-files-forest/node-v0.8.2/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
HAVE_EXPAT_H = 1
LIBDIR = '/home/skk/.node_libraries'
LIBPATH_NODE = '/home/skk/dot-files-forest/node-v0.8.2/lib'
LIBPATH_ST = '-L%s'
LIB_EXPAT = ['expat']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/skk/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/home/skk/dot-files-forest/node-v0.8.2'
