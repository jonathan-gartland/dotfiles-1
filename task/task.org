...
**** OCM
***** 4 hours billablle.  Worked on adding features described in 02/12/2013 email.
...
***** 2 hours billablle.  Worked on adding features described in 02/12/2013 email.      
*** 20
**** ResLife 
***** .5 Corrected issue with how score are calculated.
...
*** 25
**** OCM 
***** 3 hour non-billable.  Additional testing of HDW.
*** 26
**** CCOM
***** 1 hour non-billable.  Setting working on setting up drupal.
**** OCM
***** 1 hour non-billable - testing.
**** Events 
***** .5 hour non-billable.  Receibed ems support email.  Tested Events in IE to help determine cause of issue the user is reporting.
*** 27
**** OCM
***** 2 hour non-billable.  Corrections/updates to OCM.
**** CCOM
...
**** NHIHPP
***** 4 hour billable.  Worked on creating script to import user connection and system information.
***** .5 hour non-billablle.  Updated nshred to use additional options.
** March
*** 01
**** OCM
***** deployment.
