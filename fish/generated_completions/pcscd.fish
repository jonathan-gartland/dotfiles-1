...
complete -c pcscd -s c -l config --description 'Specifies the file file as an alternate locatio… [See Man Page]'
complete -c pcscd -s f -l foreground --description 'Runs pcscd in the foreground and sends log mess… [See Man Page]'
...
complete -c pcscd -s r -l max-card-handle-per-reader --description 'maximum number of card handle per reader (defau… [See Man Page]'
...
complete -c pcscd -s H -l hotplug --description 'Ask pcscd to rescan the USB buses for added or … [See Man Page]'
