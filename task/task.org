...
# HCGS: 60049
# HealthWRQS: 60140
# HealthyUNH_FitnessMap: 60059
# HealthyUNH_WalkingMap: 60428
# Housing: 59032
# NCEMRR: 60338
# MedHome: 60036
# NHIHPP: 60141
...
*** 25 
**** ePIP 
***** 1 hour billable.  Created summaries of security scan report.  Sent to summary to Eve.  Sent another to teh,aew and af.
**** OCM
...
*** 11
**** NCEMRR
***** 2 hour billable.  Had cnames renamed.  Had databases users created.  Changed references to MEDHOME/MEDHOME2 to NCEMRR.
**** Housing
***** 2 hour billable.  Updated upperclassman application and temp elg. code generation.
**** ResLife
...
**** OCM
***** 4 hours billable.  Worked on adding features described in 02/12/2013 email.
*** 16
**** WEEKEND
*** 17
**** WEEKEND
...
**** OCM
****l 1.5 hour non-billable.  Continued work on OCM Summer 2013 RFC.
*** 19
**** StaffMeetings
...
***** 2 hours billable.  Worked on adding features described in 02/12/2013 email.      
*** 20
**** ResLife 
***** .5 hour non-billable. Corrected issue with how score are calculated.
***** OCM
***** 3 hour non-billable.  Corrected issues.  Added/removed columns.
*** 21 
**** OCM
***** 3 hour non-billable.  Added additional import scripts to pull missing data.  Added generation of priv/privgroup for docs from db.
*** 22
**** RCC
***** 2 hours non-billable.  Meeting with AEW and PFM.
**** OCM
***** 3 hour non-billable.  Corrected issues.  Added/removed columns.
*** 23
**** WEEKEND
...
*** 25
**** OCM 
***** 3 hour non-billable.  Additional testing of HDW.  Minor corrections to HDW.
*** 26
**** CCOM
***** 1 hour non-billable.  Started setting up test drupal test.
**** OCM
***** 1 hour non-billable.  Testing HDW.
**** EMS 
***** .5 hour non-billable.  Received ems support email.  Tested Events in IE to help determine cause of issue the user is reporting.
*** 27
**** OCM
***** 1 hour non-billable.  Corrections/updates to OCM.
**** CCOM
***** 3 hours non-billable.  Worked on setting up Drupal.  Encountered php errors when using MySQL has a db backend.
**** EMS
***** .5 hours non-billable.  Responded to email support request.
*** 28
**** Housing
***** .5 hours non-billable.  Fixed bugs with In-hall sign-up application.
**** NHIHPP
***** 4.5 hour billable.  Worked on creating script to import user connection and system information.
***** .5 hour non-billable.  Updated nshred to use additional options.
** March
*** 01
**** OCM
***** 2 hour non-billable.  Deployment.
**** NCEMRR
***** 1 hour non-billable.  Meeting.
**** RCC
***** .25 hour non-billable.  Meeting with PFM.
**** EOS
*** 02
**** WEEKEND
*** 03
...
*** 04
**** Housing
***** .5 hour non-billable.  Checked into In-Hall sign-up issue.
**** SysMon
***** 1 hour billable.  Worked on user connection script.
***** 2 hours billable.  Worked on diskquota script.
***** 1 hour non-billable.  Meeting with Jo and Stacey to discuss unh walking map.
**** HealthyUNH_WalkingMap
***** 1 hour non-billable.  Worked on quote for Walking Map project.
*** 05
**** SysMon
***** 4 hours billable.  Updates to sysmon scripts.  Completed documentation describing the tables and their columns used.
**** StaffMeetings
***** .50 hours non-billable.  Weekly Programming Group meeting.
**** HealthyUNH_FitnessMap
***** .25 hour non-billable.  Re-imported fitness data.
**** EOS
***** .75 hour non-billable. Worked to determine if I could obtain image size information during upload.
*** 06
**** NCEMRR
***** 2.25 hours non-billable. Started quote for project.  Read through the documents provided by NHIHPP.
**** HealthyUNH_WalkingMap
***** 3 hours billable.  Began working on project.
**** RCC
***** .75 hour non-billable.  Meeting with Wendy and Pat.
*** 07
**** NCEMRR
***** 3 hours non-billable.  Worked on Quote for project.  Finished it, sent to Jo after review by Allan.
**** Bugzilla
***** .25 hour non-billable.  Created accounts for Ashley Peters.
**** HealthyUNH_WalkingMap 
***** 1.75 hour billable. Continued working on project.
*** 08
**** CURTAILED_OPERATIONS
*** 09
**** WEEKEND
...
*** 11
**** SysMon
***** 1 hour non-billable.  Researched OpenVPN and Samba logs.
**** HealthyUNH_WalkingMap
***** 5 hours billable. Continued working on project.
*** 12
**** SysMon
***** 2 hours non-billable.   Research OpenVPN and Samba logs in detail to determine what information is available.  Asked Tom to incrase logging level.
**** OCM
***** .5 hour non-billable.  Fixed bug when saving complaint form without DOB.
**** HealthyUNH_WalkingMap
***** 3 hours billable.  Continued working on project.  At this point the following features are done:  map, list of buildings, (un)-selecting of buildings (on both map and list) to show pop-up window with info and the admin interface is done.
*** 13
**** HealthyUNH_WalkingMap
***** 4 hours billable.  Continued working on project.
**** WJA_AS
***** 1 hour non-billable.  Looked into issues with data set 20 on EOS Webster.
*** 14
**** RCC
***** .5 hour non-billable.  Responded to question from Tad.
**** WJA_AS
***** 1 hour non-billable.  Corrected issues with DataSet 20 on EOS Webster.
**** HCGS
***** .5 hour non-billable.  Meet with Feseha Abebe-Akele to review updating html pages using Layout.  Added image to HCGS site.
**** EOS
***** .5 hour non-billable.  Created SwRI group on EOS site.      
**** OCM
***** .5 hour non-billable.  Corrected bug I noticed on OCM site.
...
*** 20
**** SysMon
***** 3 hour non-billable.  Worked on quote for sys-monitoring work, part 2.
**** HealthyUNH_WalkingMap
***** 2 hours non-billable.  Updates based on code review.
**** Bugzilla
***** .5 hour non-billable.  Re-created password reset token for Kimberly.Persson@unh.edu.
*** 21
**** WJA_AS
***** .5 hour non-billable.  Meeting with Annette to discuss update to PicturePost.
***** 1.5 hour non-billable.  Review Picture site and source code.
**** EOS
***** 2 hours billable.  Updated Spheres Online category in EOS Intranet.  Removed CCRC and CSRC groups.
**** HealthyUNH_WalkingMap
***** 1 hour billable.  Finished up work on project.  Sent email with update to Stacey.
*** 22
**** RCC
***** .25 hour non-billable.  Meeting with PFM.
**** WJA_AS
***** 4 hour non-billable.  Worked on quote.
**** OCM
***** .5 hour non-billable.  Fixed bug with removeal of violations not saving.
**** HealthyUNH_WalkingMap
***** 1 hour non-billable.  Spoke with Stracy about walking map.
*** 23
**** WEEKEND
*** 24
**** WEEKEND
*** 25
**** Task60455
***** 1 hour billable. Windows XP won't boot.  The BIOS reported that it couldn't find the primary hard drive.  Chris will be buying a new hard drive.
**** Task60458
***** 1 hour billable.  Determined that it is possible to update oXygen.  Installed all updates for Fedora 17.  Asked Alison if updating to 14.2 is okay.
*** 26
**** Task60463
***** 2.5 hours non-billable.  Research tools to update samba passwords for users without the ability to login.
**** OCM
***** .5 hour non-billable.  Corrected Witness field.
**** Task60458
***** .25 hour billable.  Updated oXygen to version 14.2
**** StaffMeetings
***** .75 hours non-billable.  Weekly Programming Group meeting.
**** WJA_AS
***** 1.5 hour non-billable.  Finished quote; sent to AEW for review.  Updated quote based on aew's review.  Sent to Annette.
**** Obliterase
***** .25 hour billable.  Meeting with Steve to be recorded for Kickstarter video.
*** 27
**** PicturePost
***** 5 hour billable.  Started working on project.
**** RCC
***** 1 hour non-billable.  Meeting with PFM, AEW and Pat.
*** 28
**** Task60458
***** .25 hour billable.  Allison had a problem starting Oxygen.  The menu include referneces to Oxygen 13.  I created a link in the panel to Oxygen 14.2.
**** OCM
***** 1 hour non-billable.  Added college to Three Strike Report.
**** RCC
***** .5 hour non-billable.  Meeting with PFM, AEW and Pat.
**** PicturePost
***** 5 hour billable.  Continued working on project.
*** 29
**** PicturePost
***** 5 hour billable.  Continued working on project.
**** RCC
***** 2 hours non-billable.  Cleaned out old office.
*** 30 
**** WEEKEND
*** 31 
**** WEEKEND
