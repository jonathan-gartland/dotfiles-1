...
**** HealthyUNH
***** 3 hours non-billable.  Responded to an email from Stacy.  Corrected bug in menu's display of minus/plus images when opening and closing sub-menus.  Researched using alternate map layers and using feature collections.
