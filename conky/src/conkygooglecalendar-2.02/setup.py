...
setup(
		name             = 'conkygooglecalendar',
		version          = '2.02',
		description      = 'Conky Google Calendar',
		long_description = "Google calendar script to display event data, for use in Conky",
		author           = 'Mark Buck (Kaivalagi)',
		author_email     = 'm_buck@hotmail.com',
		url              = 'None',
		platforms        = 'linux',
		license          = 'GPLv3',
		scripts          = ['conkyGoogleCalendar'],
		data_files       = [
			('/usr/share/conkygooglecalendar/', [ 'conkyGoogleCalendar.py' ] ),
			('/usr/share/conkygooglecalendar/example', listfiles( 'example', '*' ) )
		],
	)
