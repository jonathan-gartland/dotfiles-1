...
(defun wl-expireable-messages-list (folder all condition action &rest args)
  (let ((val-type (car condition))
...
(defun wl-expire-folder (folder targets condition action &rest args)
